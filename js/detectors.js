...
const yoloDetector = {
  ...
  async detect(capturedCanvas) {
    ...
    */
    ...
    const finalDetections = this.applyNMS(detections, 0.5); // 0.5 = IoU overlap threshold
    
    console.log("[yolo] Detections after NMS:", finalDetections.length);
    if (finalDetections.length > 0) console.log(finalDetections); // just dump it all
